...
// Generated:
#include "RTS_AbilitySystemComponent.generated.h"
//--------------------------------------------------------------------------------------
...
struct FEffectsParamData
{
    ...
    UPROPERTY(EditAnywhere,
        Category = "RTS Ability System Component|Effects",
...
UCLASS()
class RTS_API URTS_AbilitySystemComponent : public UAbilitySystemComponent
{
    GENERATED_BODY()
...
public:
    ...
    * @param    bDestroyingHierarchy - true, если разрушается вся иерархия компонентов, позволяет избежать дорогостоящих операций */
    ...
    UPROPERTY(EditAnywhere,
        Category = "RTS Ability System Component|Abilities")
